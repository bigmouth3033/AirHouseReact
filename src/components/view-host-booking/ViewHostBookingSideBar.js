...
export default function ViewHostBookingSideBar({ setChoice, choice }) {
  return (
    <StyledSideBar>
      <StyledItem
        $choice={choice == "all" ? true : false}
        onClick={() => setChoice("all")}
      >
        All
      </StyledItem>
      <StyledItem
        $choice={choice == "accepted" ? true : false}
        onClick={() => setChoice("accepted")}
      >
        Accepted
      </StyledItem>
      <StyledItem
        $choice={choice == "waiting" ? true : false}
        onClick={() => setChoice("wating")}
      >
        Waiting
      </StyledItem>
      <StyledItem
        $choice={choice == "denied" ? true : false}
        onClick={() => setChoice("denied")}
      >
        Denied
      </StyledItem>
      <StyledItem
        $choice={choice == "success" ? true : false}
