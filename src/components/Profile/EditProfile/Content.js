...
export default function Content(props) {
    ...
    const [phoneNumber, setPhoneNumber] = useState(props.user.user.phone_number);
                ...
                <form className='FormControll' onSubmit={e => handleSubmit(e)}>
                    ...
                    <div>
                        <ul>
                            ...
                            <li><input type='text' value={phoneNumber} onChange={e => handlePhoneNumber(e)} placeholder='+84 xxxxxxxxx' /></li>
                    ...
                    <div>
                        <ul>
                            ...
                            <li><select name="gender" id="gender" onChange={e => handleGender(e)}>
                    ...
                    <div>
                        <ul>
                            ...
                            <li><input type='text' value={address} onChange={e => setAddress(e.target.value)} /></li>
                        </ul>
                    </div>
                    <div>
                        <ul>
                            <li><label>Describe Yourself</label></li>
                            <li><input type='text' value={about} onChange={e => setAbout(e.target.value)} /></li>
                        </ul>
                    </div>
                    {(isValidFN || isValidLN || isValidPhone) ? <input type='submit' className='submitInput' disabled /> : <input type='submit' className='submitInput' />}
