...
`;
const StyledContainerEmail = styled.div`
  position: relative;
`;
const StyledBirthday = styled.input`
  width: 440px;
  height: 45px;
  border-radius: 8px;
  border: 1px solid #dddddd;
      ...
      <StyledForm>
        <form>
          <StyledFormContainer>
            ...
            <StyledContainerEmail className="custom-date-input">
              <StyledBỉthday
                type="date"
                value={selectedDate}
                onChange={handleDateChange}
              />
              <StyledLable>Birthday</StyledLable>
            </StyledContainerEmail>
            <StyledSpan>
