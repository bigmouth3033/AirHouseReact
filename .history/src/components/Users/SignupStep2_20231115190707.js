...
import { differenceInYears, getYear, isBefore, parseISO } from "date-fns";
...
const SignupStep2 = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Kiểm tra ngày sinh trước khi thực hiện hành động gửi form
    const selectedDate = new Date(birthday);
    const today = new Date();
    const age = today.getFullYear() - getYear(selectedDate);
    ...
    <StyledContainer>
      ...
      <StyledForm>
        <form onSubmit={handleSubmit}>
          ...
          <StyledButtonSubmit
            type="submit"
            disabled={errorText || !formSubmitted}
          >
            Continute
          </StyledButtonSubmit>
        </form>
