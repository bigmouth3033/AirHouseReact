...
const StyledWith = styled.div`
  ...
  &::after {
    ...
    width: 10px; /* Độ rộng của gạch ngang */
    border-top: 1px solid #000; /* Màu và chiều dày của gạch ngang */
    border-bottom: 1px solid #000; /* Màu và chiều dày của gạch ngang */
    margin: 0 5px;
  }
  &::before {
    content: "";
    display: inline-block;
    width: 100px; /* Độ rộng của gạch ngang */
    border-top: 1px solid #000; /* Màu và chiều dày của gạch ngang */
    border-bottom: 1px solid #000; /* Màu và chiều dày của gạch ngang */
    margin: 0 5px;
  }
