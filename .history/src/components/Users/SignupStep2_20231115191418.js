...
const SignupStep2 = () => {
     ...
     const validateBirthday = () => {
       ...
       if (isNaN(selectedDate.getTime())) {
         setErrorText('Ngày sinh không hợp lệ.');
       } else if (age < 18) {
         setErrorText('Bạn phải đủ 18 tuổi.');
       } else if (selectedDate > today) {
         setErrorText('Ngày sinh không thể là tương lai.');
       } else {
         setErrorText('');
         alert('Đã nhập ngày sinh hợp lệ!');
       }
    ...
    <StyledContainer>
      ...
      <StyledForm>
        <form onSubmit={handleSubmit}>
          ...
          <StyledButtonSubmit type="submit" onClick={validateBirthday}>Continute</StyledButtonSubmit>
        </form>
