...
`;
const mediaQuery = styled(StyledContainer)`
  /* Thiết lập kiểu dáng cho màn hình có chiều rộng dưới 780px */
  @media (max-width: 780px) {
    /* Thực hiện các điều chỉnh kiểu dáng tại đây */
    /* Ví dụ: giảm padding, thay đổi font-size, ... */
    ${StyledSecion1} {
      min-height: auto;
    }
