        ...
        <div>
          <form>
            ...
            <StyledContainerBooking>
              <StyledBooking>
                <StyledCheck>
                  <StyledCheckin onClick={handleClickCalendar}>
                    <label>Checkin</label>
                    <div>{`${format(
                  ...
                  <StyledCheckout onClick={handleClickCalendar}>
                  ...
                  {isOpenCalendar && (
                    ...
                    >
                      <StyledCalendar onClick={handleCalendarClick}>
                        {isOpenCalendar && <CalendarViewHost data={data} />}
                      </StyledCalendar>
                    </div>
                  )}
                </StyledCheck>

                <StyledCountGuest onClick={handleClickGuest}>
                  <label>Guests</label>
              ...
              <div>
                {showText && isOpenGuest && (
                  <div>
                    <StyledGuest onClick={handleCloseGuest}>
                      <StyledAdultChildren>
                        <div>Adults</div>
                        <div>
                          <StyledAddSub>
